...
ggsave("KENT_Plot_1.png",plot=plot.2)
...
ggsave("Kent_Plot_2.png",plot=plot.4)
...
#model 3 has the largest R^2 values meaning this movel explains 64% of vraiation in the data. It also has the lowest Root Mean Square Error, meaning the model fit s the data well and has more percise predictions than the other models. 
...
ggsave("Kent_Plot_3.png",plot=plot.5)
